                ...
                <div class="modal-content p-3 p-md-5">
                    <div class="modal-body">
                        ...
                        <form id="addNewCCForm" class="row g-3"
                            action="{{ route('admin.parcel.setting.item.category.store') }}" method="POST">
                            @csrf
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <label class="form-label w-100" for="details">Details</label>
                                <div class="input-group input-group-merge">
                                    <input id="details" name="details" class="form-control credit-card-mask"
                                        type="text" placeholder="Details" />
                                </div>
                            </div>
                            <div class="col-12">
                                <label class="form-label w-100" for="details">Rate</label>
                                <div class="input-group input-group-merge">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group input-group-merge">
                                    <input id="editname" name="name" class="form-control" type="text"
                                        placeholder="Vehicle" aria-describedby="name2" required />
                                </div>
                            </div>
                            <div class="col-12">
                                <label class="form-label w-100" for="edidetails">Details</label>
                                <div class="input-group input-group-merge">
                                    <input id="editdetails" name="details" class="form-control" type="text"
                                        placeholder="Details" aria-describedby="name2" />
                                </div>
                            </div>
                            <div class="col-12">
                                <label class="form-label w-100" for="edidetails">Details</label>
                                <div class="input-group input-group-merge">
                                    <input id="editrate" name="rate" class="form-control" type="number"
                                        placeholder="0.00" step="any" required />
                                </div>
                            </div>
                            <div class="col-12 text-center mt-4">
...
@section('inline-js')
    <script type="text/javascript">
        function editRow(data) {
            ...
            let url = "{{ route('admin.parcel.setting.item.category.update', 'id') }}"
        ...
        function deleteRow(id, status) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const basePath = "{{ route('admin.parcel.setting.item.category.delete') }}"
