...
<head>
    ...
    <link rel="stylesheet" href="/frest/vendor/libs/spinkit/spinkit.css" />
...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            @include('themes.frest.partials.merchantPanel.aside')
            <!-- / Menu -->
    ...
    <script src="/frest/vendor/libs/block-ui/block-ui.js"></script>
    <script src="/frest/js/extended-ui-blockui.js"></script>
