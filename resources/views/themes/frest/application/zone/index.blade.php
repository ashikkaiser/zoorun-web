...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header border-bottom d-flex">
            <h5 class="card-title">Zone List</h5>
            <div class="card-header-elements ms-auto">
                <a href="{{ route('admin.application.zone') }}"
                    class="btn btn-sm {{ request()->status !== 'trash' ? 'btn-dark' : '' }}"><span
                        class="tf-icon bx bx-check bx-xs"></span>
                    Active</a>
                <a href="{{ route('admin.application.zone', ['status' => 'trash']) }}"
                    class="btn btn-sm {{ request()->status === 'trash' ? 'btn-dark' : '' }}"><span
            ...
            <div class="modal-dialog modal-dialog-centered1 modal-simple modal-add-new-cc">
                <div class="modal-content p-3 p-md-5">
                    <div class="modal-body">
                        ...
                        <form class="row g-3" action="{{ route('admin.application.zone.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group input-group-merge">
                                    <input id="name" name="name" class="form-control credit-card-mask"
                                        type="text" placeholder="Zone Name" aria-describedby="name2" required />
                                </div>
                            </div>
                            <div class="col-12">
                                <label class="form-label w-100" for="name">Color</label>
                                <div class="input-group input-group-merge">
                                    <input id="color" name="color" class="form-control credit-card-mask"
                ...
                <div class="modal-content p-3 p-md-5">
                    <div class="modal-body">
                        ...
                        <form id="editModalForm" class="row g-3" method="POST">
                            ...
                            <div class="col-12">
                                <label class="form-label w-100" for="editColor">Color</label>
                                <div class="input-group input-group-merge">
                                    <input id="editColor" name="color" class="form-control credit-card-mask"
                                        type="text" placeholder="Color Name" aria-describedby="name2" required />
                                </div>
                            </div>
...
@section('inline-js')
    <script type="text/javascript">
        function editRow(data) {
            ...
            let url = "{{ route('admin.application.zone.update', 'id') }}"
        ...
        function deleteRow(id, status) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const basePath = "{{ route('admin.application.zone.delete') }}"
