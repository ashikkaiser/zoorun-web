...
@section('title', 'Admin - Merchant List')
...
@section('content')
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex">
            <h5 class="card-title">Merchants List</h5>
            <div class="card-header-elements ms-auto">
                ...
                <a href="{{ route('admin.team.branch', ['status' => 'trash']) }}"
                    ...
                    Trash</a>
                <a href="{{ route('admin.team.merchant.create') }}" type="button" class="btn btn-sm btn-primary"><span
