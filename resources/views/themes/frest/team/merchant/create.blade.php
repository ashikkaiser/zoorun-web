...
@section('content')
    ...
    <div class="card mt-4">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Create New Merchant</h4>
            </div>
            <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 mb-2 mb-3">
                                ...
                                <textarea class="form-control" name="personal_address" rows="3" placeholder="Full Address" spellcheck="false"
                                    id="personal_address" required style="color: rgb(48, 65, 86);"></textarea>
                            </div>
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <textarea class="form-control" name="company_address" rows="3" placeholder="Business Address" id="company_address"
                                    spellcheck="false" style="color: rgb(48, 65, 86);"></textarea>
                            </div>
...
@section('inline-js')
    <script type="text/javascript">
        $('#district').on('select2:select', function(e) {
            ...
            fetch(`{{ route('admin.application.getarea') }}?district=${e.target.value}`)
