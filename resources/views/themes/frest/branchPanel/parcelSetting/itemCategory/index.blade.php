...
@section('title', 'Branch - Item Category')
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group input-group-merge">
                                    <input id="details" name="details" class="form-control credit-card-mask"
                                        type="text" placeholder="Details" aria-describedby="name2" />
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <form id="editModalForm" class="row g-3" method="POST">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group input-group-merge">
                                    <input id="edidetails" name="details" class="form-control credit-card-mask"
                                        type="text" placeholder="Details" aria-describedby="name2" />
                                </div>
                            </div>
                            <div class="col-12 text-center mt-4">
