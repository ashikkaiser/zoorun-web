...
class ParcelSettingController extends Controller
{
    ...
    public function vihicle(Request $request, Builder $builder)
    {
        ...
        if (request()->ajax()) {
            return DataTables::of($rowData)->addColumn('action', function ($row) {
                return view('themes.frest.branchPanel.parcelSetting.vehicle.action', compact('row'));
        ...
        return view('themes.frest.branchPanel.parcelSetting.vehicle.index', compact('html'));
    }
    /**
    ...
    public function unit(Request $request, Builder $builder)
    {
        ...
        if (request()->ajax()) {
            return DataTables::of($rowData)->addColumn('action', function ($row) {
                return view('themes.frest.branchPanel.parcelSetting.unit.action', compact('row'));
            })->editColumn('created_at', '{{date("d-M-Y", strtotime($created_at))}}')->addColumn('status', function ($row) {
                return view('themes.frest.partials.status', compact('row'));
            })->toJson();
        }
        ...
        return view('themes.frest.branchPanel.parcelSetting.unit.index', compact('html'));
    }
    /**
     * Store a newly created resource in storage.
     *
    ...
    public function itemcategory(Request $request, Builder $builder)
    {
        ...
        if (request()->ajax()) {
            return DataTables::of($rowData)->addColumn('action', function ($row) {
                return view('themes.frest.branchPanel.parcelSetting.itemCategory.action', compact('row'));
            })->editColumn('created_at', '{{date("d-M-Y", strtotime($created_at))}}')->addColumn('status', function ($row) {
                return view('themes.frest.partials.status', compact('row'));
            })->toJson();
        }
        ...
        return view('themes.frest.branchPanel.parcelSetting.itemCategory.index', compact('html'));
    }
    /**
     * Store a newly created resource in storage.
     *
    ...
    public function item(Request $request, Builder $builder)
    {
        ...
        if (request()->ajax()) {
            return DataTables::of($rowData)->addColumn('action', function ($row) {
                return view('themes.frest.branchPanel.parcelSetting.item.action', compact('row'));
            })->editColumn('created_at', '{{date("d-M-Y", strtotime($created_at))}}')->addColumn('status', function ($row) {
                return view('themes.frest.partials.status', compact('row'));
            })->toJson();
        }
        ...
        return view('themes.frest.branchPanel.parcelSetting.item.index', compact('html', 'itemCategories', 'units'));
    }
    /**
     * Store a newly created resource in storage.
     *
